    ...
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="bg-[var(--color-bg-secondary)] border-t border-[var(--color-border-subtle)] pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-[60px]">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-[1.4fr_0.85fr_1fr_1fr_1.35fr] lg:gap-8 mb-16">
            <div>
              <Logo className="h-14 md:h-16 gap-5 mb-7" labelClassName="text-2xl md:text-3xl" />
            ...
            <div>
              <h4 className="font-display text-xl tracking-wider mb-6 lg:mt-4">Quick Links</h4>
            ...
            <div>
              <h4 className="font-display text-xl tracking-wider mb-6 lg:mt-4">Services</h4>
              <ul className="space-y-4">
            ...
            <div>
              <h4 className="font-display text-xl tracking-wider mb-6 lg:mt-4">Contact</h4>
              <ul className="space-y-4">
