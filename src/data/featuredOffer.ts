...
export const featuredOfferPresets: FeaturedOffer[] = [
  ...
  { enabled: true, campaignType: 'Website Audit', eyebrow: 'A clearer website starts here', title: 'Find what’s holding your website back.', description: 'Get a practical look at where your website is losing attention, trust, or enquiries.', buttonLabel: 'Get a Free Website Audit', formPrompt: 'What would you like us to review on your website?' },
  { enabled: true, campaignType: 'Social Media Audit', eyebrow: 'Make your content work harder', title: 'Your social media can do more.', description: 'Get a focused review of your content, positioning, and opportunities to turn attention into action.', buttonLabel: 'Get a Free Social Media Audit', formPrompt: 'What would you like us to review on your social media?' },
  { enabled: true, campaignType: 'Brand Review', eyebrow: 'See your brand with fresh eyes', title: 'Make your brand easier to choose.', description: 'Get an outside perspective on your message, visual presence, and the next move for your business.', buttonLabel: 'Get a Free Brand Review', formPrompt: 'What would you like us to review about your brand?' },
];
